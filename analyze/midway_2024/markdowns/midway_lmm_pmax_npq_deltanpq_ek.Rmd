...
```{r}
mid_ps <- read_csv("/Users/angela/src/Photosynthesis/data/midway/2024/transformed/midway_ek_alpha_normalized_2024.csv")
...
```{r}
time_over_28 <- read_csv("/Users/angela/src/Photosynthesis/data/midway/2024/transformed/mins_28_plant_part.csv") #load dataset
...
```{r}
growth_rate <- read.csv("/Users/angela/src/Photosynthesis/data/midway/2024/input/midway_growth.csv")
